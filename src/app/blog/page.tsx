...
export const metadata = {
  title: "Blog | PLG Hub",
  description: "Latest blog posts and insights from the PLG Hub team.",
  openGraph: {
    title: "Blog | PLG Hub",
    description: "Latest blog posts and insights from the PLG Hub team.",
  ...
  icons: {
    shortcut: "/images/landing/plg-hub.png",
  },
};

export const revalidate = 60;

const BlogPage = generatePage(
  async ({
    searchParams,
  }: {
    ...
    const [supabase, { category_title, page }] = await Promise.all([
      createClient(),
      searchParams,
    ]);
    ...
    if (category_title) {
      storiesQuery = storiesQuery.eq(
        "category_title",
        decodeURIComponent(category_title),
      );
    }
            ...
            <div className="relative pt-16 pb-6 sm:px-12 sm:pb-20">
              ...
              <nav className="mt-10 hidden w-fit items-center gap-x-2 gap-y-4 sm:flex sm:flex-wrap">
                <Button
                  ...
                  size="sm"
                  variant={!category_title ? "default" : "ghost"}
                >
                ...
                {categories && categories.length > 0 ? (
                  categories.map((category: { title: string }) => (
                    <Button
                      ...
                      asChild
                      variant={
                        category_title === category.title ? "default" : "ghost"
                      }
                      className="text-sm font-medium"
                      size="sm"
                    >
